cmd_/host/so/lab5/seri.o := gcc -m32 -Wp,-MD,/host/so/lab5/.seri.o.d  -nostdinc -isystem /usr/lib/gcc/i486-linux-gnu/4.1.2/include -D__KERNEL__ -Iinclude  -include include/linux/autoconf.h -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -O2 -pipe -msoft-float -mpreferred-stack-boundary=2  -march=i686  -mregparm=3 -ffreestanding -maccumulate-outgoing-args -DCONFIG_AS_CFI=1 -DCONFIG_AS_CFI_SIGNAL_FRAME=1 -Iinclude/asm-i386/mach-default -fomit-frame-pointer  -fno-stack-protector -Wdeclaration-after-statement -Wno-pointer-sign   -DMODULE -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(seri)"  -D"KBUILD_MODNAME=KBUILD_STR(seri)" -c -o /host/so/lab5/.tmp_seri.o /host/so/lab5/seri.c

deps_/host/so/lab5/seri.o := \
  /host/so/lab5/seri.c \
  ...
  /host/so/lab5/seri.h \
  /host/so/lab5/serial_reg.h \
  /host/so/lab5/ioctl.h \

/host/so/lab5/seri.o: $(deps_/host/so/lab5/seri.o)
