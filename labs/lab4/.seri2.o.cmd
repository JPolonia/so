cmd_/host/so/lab4/seri2.o := gcc -m32 -Wp,-MD,/host/so/lab4/.seri2.o.d  -nostdinc -isystem /usr/lib/gcc/i486-linux-gnu/4.1.2/include -D__KERNEL__ -Iinclude  -include include/linux/autoconf.h -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -O2 -pipe -msoft-float -mpreferred-stack-boundary=2  -march=i686  -mregparm=3 -ffreestanding -maccumulate-outgoing-args -DCONFIG_AS_CFI=1 -DCONFIG_AS_CFI_SIGNAL_FRAME=1 -Iinclude/asm-i386/mach-default -fomit-frame-pointer  -fno-stack-protector -Wdeclaration-after-statement -Wno-pointer-sign   -DMODULE -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(seri2)"  -D"KBUILD_MODNAME=KBUILD_STR(seri2)" -c -o /host/so/lab4/.tmp_seri2.o /host/so/lab4/seri2.c

deps_/host/so/lab4/seri2.o := \
  /host/so/lab4/seri2.c \
...
/host/so/lab4/seri2.o: $(deps_/host/so/lab4/seri2.o)
